temperatures <- read_csv(paste0("https://pkgstore.datahub.io/core/global-temp/",
                                "annual_csv/data/a26b154688b061cdd04f1df36e4408be/annual_csv.csv"))
...
ggplot(temperatures, aes(x = Year, y = Mean)) +
  ...
  labs(
    ...
    caption = paste0("Source: https://datahub.io/core/global-temp\n",
                     "Visualization: Esben Kran Christensen")
    ) +
...
ggsave(width = 13, height = 8, "Adventures/temperatures.png")
