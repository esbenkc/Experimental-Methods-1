...
sleepData$toBed <-
  chron(times = sleepData$toBed, format = c(times = "h:m:s"))

# Time is a tough one
sleepData


# Importing and manipulation of Toggl time data
personalData = read.csv("Toggl_summary_report_2019-01-01_2019-12-31.csv")

companyData = read.csv("Toggl_summary_report_2019-01-01_2019-12-32.csv")
